...
private:
	...
	// Якою саме збудовано поточну геометрію: рухоме тіло вимагає опуклої оболонки,
	// а нерухоме користується трикутною сіткою, тому кеш залежить не лише від масштабу
	bool mGeometryIsConvex = false;
};
